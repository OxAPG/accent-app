...
export default function AccentRoaster() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFF00] font-mono p-4 flex flex-col items-center justify-center text-black overflow-hidden select-none">
      ...
      {/* --- HIDDEN LEGAL SHIELD --- */}
<footer className="mt-20 w-full max-w-sm px-4 pb-10 opacity-5 hover:opacity-100 transition-opacity duration-500 text-center cursor-default">
  <div className="border-t-2 border-black pt-4">
    <h3 className="text-[10px] font-black uppercase mb-2">Legal Disclaimer / Terms of Service</h3>
    <div className="text-[8px] font-bold uppercase leading-tight text-left space-y-2">
      <p>
        1. **AI LIABILITY:** This is an experimental AI project powered by Llama 3.3. We are NOT liable for any "reads," insults, or character assassinations generated by the model. The AI is unhinged by design.
      </p>
      <p>
        2. **NO GUARANTEES:** This is a "for-fun" project. We take zero responsibility for any harm, emotional distress, or loss of "aura" caused to any human, bot, or animal.
      </p>
      <p>
        3. **DATA PRIVACY:** Audio is processed as a transient base64 string. We do not store your voice. We do not want your data; we just want to roast your accent.
      </p>
      <p>
        4. **HERITAGE ACCURACY:** The DNA percentages are for entertainment only and have the scientific accuracy of a horoscope. Don't use this to apply for a passport.
      </p>
      <p>
        5. **BY USING THIS APP:** You agree that you are 13+ and that you won't cry if a computer tells you that your "R" sounds like a dying lawnmower.
      </p>
    </div>
    <p className="mt-4 text-[8px] font-black opacity-40">© 2026 ACCENT ASSASSIN LAB // ALL RIGHTS RESERVED (MAYBE).</p>
  </div>
</footer>
    </div>
  );
